...
import { FeaturedCollectionStack } from "@/components/featured-collection-stack";
    ...
    <main className="min-h-screen px-4 py-6 md:px-6 md:py-8">
      <div className="mx-auto max-w-7xl space-y-8">
        <section className="overflow-hidden rounded-[42px] border border-white/70 bg-white/84 shadow-[0_32px_100px_rgba(15,23,42,0.12)] backdrop-blur-xl">
          <div className="grid gap-10 px-6 py-8 md:px-10 md:py-12 xl:grid-cols-[minmax(0,1.02fr)_minmax(22rem,0.92fr)]">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                {entryCards.map((entry) => (
                  <Link
                    ...
                    className="group flex h-full min-h-[14rem] flex-col rounded-[30px] border border-slate-100 bg-slate-50/80 p-5 transition hover:-translate-y-0.5 hover:border-slate-200 hover:bg-white"
                  >
            ...
            <div className="relative rounded-[36px] border border-slate-100 bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(239,246,255,0.9))] p-6 md:p-7">
              ...
              <FeaturedCollectionStack collections={featuredCollections} className="pt-8" />
            </div>
          </div>
        </section>
