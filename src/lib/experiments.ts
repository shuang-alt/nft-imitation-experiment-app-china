...
const nftTerm = "NFT（数字艺术品）";
const nftCollectionTerm = "NFT collection（数字艺术品项目）";
const collectionTerm = "collection（项目）";
const nftMarketplaceTerm = "NFT marketplace（数字艺术品交易平台）";
const openSeaTerm = "OpenSea（数字艺术品交易平台）";
const cryptocurrencyTerm = "cryptocurrency（加密货币）";
const firstNftCollectionTerm = `第一个 ${nftCollectionTerm}`;
const secondNftCollectionTerm = `第二个 ${nftCollectionTerm}`;

const nftExperienceItems = [
  `我熟悉 ${nftMarketplaceTerm}`,
  `我了解 ${nftCollectionTerm}的基本信息`,
  `我曾经关注过 ${nftTerm}项目`,
  `我曾经购买过 ${nftTerm}`,
  `我平时对 ${nftTerm}感兴趣`,
  `我经常浏览类似的${nftMarketplaceTerm}`,
];
...
const demographicFields: DemographicField[] = [
  ...
  },
  {
    ...
    label: `您是否持有 ${cryptocurrencyTerm}：`,
    kind: "radio",
    options: ["是", "否"],
  },
  {
    key: "purchased_nft",
    label: `您是否购买过 ${nftTerm}：`,
    kind: "radio",
    options: ["是", "否"],
  },
];
  ...
  return [
    {
      ...
      paragraphs: [
        "感谢您参与本研究。",
        `本研究旨在了解用户在浏览 ${nftMarketplaceTerm}时的看法与决策过程。`,
        `在接下来的页面中，您将看到一些 ${nftCollectionTerm}的展示信息。请像平时浏览数字藏品平台如 ${openSeaTerm} 一样查看这些内容。`,
        `随后，我们会询问您对某个 ${nftCollectionTerm}的印象和看法。`,
    ...
    },
    {
      ...
      introLines: [
        `请想象你正在浏览一个 ${nftMarketplaceTerm}。`,
        `下面展示的是平台上的一个 ${nftCollectionTerm}。`,
      ...
      footerLines: [
        `请根据平时浏览 ${nftMarketplaceTerm}的习惯查看以上信息。`,
        "点击“下一页”继续。",
      ],
      sidebarCollectionKeys: [condition === "control" ? "goopTroop" : "basedOnChainDinos"],
    },
    {
      ...
      introLines: [
        `现在请继续浏览下面这个 ${nftCollectionTerm}。`,
        `请继续认真查看本页展示的信息，接下来的问题将涉及这两个${nftCollectionTerm}，请根据页面信息作答。`,
      ],
      ...
      cardPresentation: "study1-browse",
      footerLines: [
        `请根据您对刚才浏览过的两个${nftCollectionTerm}的印象，在接下来的问题中作答。`,
        "点击“下一页”继续。",
      ],
    ...
    },
    {
      ...
      question: `这两个${nftCollectionTerm}中，哪一个创建时间更早？`,
      answerKey: "earlier_creation_judgment_1",
      options: [
        {
          value: "first_created_earlier",
          label: `${firstNftCollectionTerm}更早创建`,
        },
        {
          value: "second_created_earlier",
          label: `${secondNftCollectionTerm}更早创建`,
        },
      ],
    },
    {
      ...
      introLines: [
        `以下问题是关于刚才浏览的两个${nftCollectionTerm}的关系判断。`,
        "请根据您刚才看到的页面信息，选择最符合您判断的一项。",
      ],
      question: `您认为刚才看到的两个${nftCollectionTerm}中，哪一个在模仿另一个？`,
      answerKey: "imitation_direction_1",
      options: [
        {
          value: "first_imitates_second",
          label: `${firstNftCollectionTerm}在模仿${secondNftCollectionTerm}`,
        },
        {
          value: "second_imitates_first",
          label: `${secondNftCollectionTerm}在模仿${firstNftCollectionTerm}`,
        },
        {
    ...
    },
    {
      ...
      introLines: [
        `以下问题是关于刚才浏览的${secondNftCollectionTerm}。`,
        "请根据您的真实感受回答。",
      ],
      scaleLabel: fivePointScaleLabel,
      items: [
        `浏览页面后，${secondNftCollectionTerm}吸引了我的注意`,
        `浏览页面后，我对${secondNftCollectionTerm}更感兴趣`,
        `浏览页面后，我想进一步了解${secondNftCollectionTerm}`,
        `浏览页面后，${secondNftCollectionTerm}给我留下了较深的印象`,
      ],
    ...
    },
    {
      ...
      introLines: [`以下问题仍然关于刚才浏览的${secondNftCollectionTerm}。`],
      scaleLabel: fivePointScaleLabel,
      items: [
        `我会考虑购买${secondNftCollectionTerm}的${nftTerm}`,
        `我对购买${secondNftCollectionTerm}的${nftTerm}感兴趣`,
        `${secondNftCollectionTerm}是一个值得考虑购买的${nftCollectionTerm}`,
        `如果价格合适，我愿意购买${secondNftCollectionTerm}的${nftTerm}`,
      ],
      answerKeys: [
        "purchase_interest_1",
        "purchase_interest_2",
    ...
    },
    {
      ...
      introLines: [
        `以下问题是关于刚才浏览的${firstNftCollectionTerm}与${secondNftCollectionTerm}之间的关系。`,
      ],
      scaleLabel: fivePointScaleLabel,
      items: [
        `${firstNftCollectionTerm}可以作为${secondNftCollectionTerm}的替代`,
        `我可能会购买${firstNftCollectionTerm}，而不是${secondNftCollectionTerm}`,
        `${firstNftCollectionTerm}降低了我对${secondNftCollectionTerm}的购买兴趣`,
        `看完${firstNftCollectionTerm}后，我不想再继续搜索${secondNftCollectionTerm}的相关信息。`,
      ],
      answerKeys: [
        "substitution_1",
        "substitution_2",
    ...
    },
    {
      ...
      introLines: [`以下问题用于了解您的${nftTerm}使用经验。`],
      scaleLabel: fivePointScaleLabel,
  ...
  return [
    {
      ...
      paragraphs: [
        "感谢您参与本研究。",
        `本研究旨在了解用户在浏览 ${nftMarketplaceTerm}时的看法与决策过程。`,
        `在接下来的页面中，您将看到两个 ${nftCollectionTerm}的展示信息。请像平时浏览数字藏品平台一样查看这些内容。`,
        `随后，我们会询问您对其中一个 ${nftCollectionTerm}的印象和看法。`,
        "本研究仅用于学术研究，所有回答将匿名处理。",
        "请点击“下一页”继续。",
      ],
    ...
    },
    {
      ...
      collectionLabels: [firstNftCollectionTerm, secondNftCollectionTerm],
      cardImageCount: 3,
      metadataEmphasis: true,
      footerLines: [
        `请像平时浏览 ${nftMarketplaceTerm}一样查看这些信息。`,
        `请根据您刚才浏览过的两个${nftCollectionTerm}的印象，在接下来的问题中作答。`,
        "点击“下一页”继续。",
      ],
      sidebarCollectionKeys: [
        "tinyDinosEth",
    ...
    },
    {
      ...
      introLines: [
        `以下问题是关于刚才浏览的两个${nftCollectionTerm}的关系判断。`,
        "请根据您刚才看到的页面信息，选择最符合您判断的一项。",
        `其中，${firstNftCollectionTerm}和${secondNftCollectionTerm}分别对应您刚才浏览页面中的左侧与右侧集合。`,
      ],
      question: `您认为刚才看到的两个${nftCollectionTerm}中，哪一个在模仿另一个？`,
    ...
    },
    {
      ...
      introLines: [
        `以下问题是关于刚才浏览的${firstNftCollectionTerm}。`,
        "请根据您的真实感受回答。",
        `这里的${firstNftCollectionTerm}指您刚才在上一页首先看到的左侧${collectionTerm}。`,
      ],
      scaleLabel: fivePointScaleLabel,
      items: [
        `${firstNftCollectionTerm}吸引了我的注意`,
        `浏览页面后，我对${firstNftCollectionTerm}更感兴趣`,
        `我想进一步了解${firstNftCollectionTerm}`,
        `${firstNftCollectionTerm}给我留下了较深的印象`,
      ],
      answerKeys: ["awareness_1", "awareness_2", "awareness_3", "awareness_4"],
      questionStyle: "matrix-stars",
      sidebarCollectionKeys: [
    ...
    },
    {
      ...
      introLines: [
        `以下问题仍然关于刚才浏览的${firstNftCollectionTerm}。`,
        `这里的${firstNftCollectionTerm}指您刚才首先看到的${collectionTerm}。`,
      ],
      scaleLabel: fivePointScaleLabel,
      items: [
        `我会考虑购买${firstNftCollectionTerm}的${nftTerm}`,
        `我对购买${firstNftCollectionTerm}的${nftTerm}感兴趣`,
        `${firstNftCollectionTerm}是一个值得考虑购买的${nftCollectionTerm}`,
        `如果价格合适，我愿意购买${firstNftCollectionTerm}的${nftTerm}`,
      ],
      answerKeys: [
        "purchase_interest_1",
        "purchase_interest_2",
    ...
    },
    {
      ...
      introLines: [
        `以下问题是关于刚才浏览的${firstNftCollectionTerm}与${secondNftCollectionTerm}之间的关系。`,
        `其中，${firstNftCollectionTerm}指您先看到的${collectionTerm}，${secondNftCollectionTerm}指随后看到的${collectionTerm}。`,
      ],
      scaleLabel: fivePointScaleLabel,
      items: [
        `${secondNftCollectionTerm}可以作为${firstNftCollectionTerm}的替代`,
        `我可能会购买${secondNftCollectionTerm}，而不是${firstNftCollectionTerm}`,
        `${secondNftCollectionTerm}降低了我对${firstNftCollectionTerm}的购买兴趣`,
        `看完${secondNftCollectionTerm}后，我不想再继续搜索${firstNftCollectionTerm}的相关信息。`,
      ],
      answerKeys: [
        "substitution_1",
        "substitution_2",
